...
extension Theme where Site == NonDotDev {
    static var anneTheme: Self {
        Theme(
            htmlFactory: AnneThemeHTMLFactory()
        )
    }
}

private struct AnneThemeHTMLFactory<Site: Website>: HTMLFactory {
